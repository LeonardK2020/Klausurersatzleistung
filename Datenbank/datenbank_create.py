...
sql_create1 = "Create table aufgaben  (aufgaben_id INTEGER PRIMARY KEY AUTOINCREMENT, wochentag TEXT ,  name TEXT, uhrzeit TEXT ,  datum_abgabe_tag TEXT , datum_abgabe_monat TEXT, priorität TEXT, benutzer_id INTEGER ,FOREIGN KEY(benutzer_id) REFERENCES benutzer(benutzer_id) )" 
